...
echo "repopulate $SOURCE_PATH|$DATABASE|ori_install_dump_db_owner=$ori_install_dump_db_owner|ori_db_user=$ori_db_user|install_dump_db_owner=$install_dump_db_owner|db_user=$db_user" &>> $LOG_FILE
